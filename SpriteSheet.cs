...
public static class SpriteSheet
{
    ...
    public static readonly Rectangle FaceDiscovering = new(1 + 25 + 25, 25, 24, 24);
    public static readonly Rectangle FaceWon = new(1 + 25 + 25 + 25, 25, 24, 24);
    public static readonly Rectangle FaceLost = new(1 + 25 + 25 + 25 + 25, 25, 24, 24);
